...
<script>
/* Based on https://github.com/Shard-Labs/vue-swipy */
...
const SWIPING_RIGHT = 'swiping-right'
const SWIPING_LEFT = 'swiping-left'
  ...
  mounted() {
    ...
    interact(element).draggable({
      ...
      onmove: (event) => {
        ...
        if (x > thresholdX) this.$emit(SWIPING_RIGHT)
        else if (x < -thresholdX) this.$emit(SWIPING_LEFT)
      },
      onend: () => {
